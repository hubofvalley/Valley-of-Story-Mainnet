...
- current story node version: ${CYAN}v1.4.1${RESET}
- current story-geth node version: ${CYAN}v1.1.2${RESET}
"
...
- enode: ${BLUE}enode://0c8ac41a0249cbfbdeac561962dd723f80d0a03aec7e9cfa0bee80990e7ec974139ab3e627376725f0afe37e5ae4c36ea7b941f7ebf1742257e2d58eadae58a3@enode-mainnet-story.grandvalleys.com:37303${RESET}
...
echo "export STORY_CHAIN_ID="story"" >> ~/.bash_profile
...
function install_story_app() {
    ...
    wget -O story-v1.4.1/story https://github.com/piplabs/story/releases/download/v1.4.1/story-linux-amd64
...
function show_guidelines() {
    ...
    echo -e "${GREEN}Install Story App only: Installs the Story app (v1.4.1) for executing transactions without running the node.${RESET}"
...
function menu() {
    ...
    echo -e "${GREEN}4. Install the Story App (v1.4.1) only to execute transactions without running a node${RESET}"
